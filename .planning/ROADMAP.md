...
Plans:
- [ ] 01-01: Expo + TypeScript scaffolding, NativeWind v4 full configuration (Babel, Metro, global.css), smoke test
- [ ] 01-02: Design token TypeScript files — color, typography, spacing, radius, shadow, grid tokens in tailwind.config.ts
- [ ] 01-03: Storybook React Native v7 setup — on-device runner, env-var toggle, font decorator, token showcase stories
- [ ] 01-04: Utility layer — cn() helper, cva convention documented, barrel export skeleton
